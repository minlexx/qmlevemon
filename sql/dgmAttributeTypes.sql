...
INSERT INTO dgmAttributeTypes VALUES(3,'damage','current damage dealt to module',1386,0.0,1,'Item Damage',113,1,1,7);
...
INSERT INTO dgmAttributeTypes VALUES(252,'entitySecurityStatusKillBonus',replace(replace('How much security status is modified by for killing this entity.  Depending on the entity, this may be a positive or negative amount.\r\nValue is a % movement of the character''s current security towards the upper/lower limit.','\r',char(13)),'\n',char(10)),NULL,0.0,1,'Security Status Kill Amount',109,1,1,32);
...
INSERT INTO dgmAttributeTypes VALUES(422,'techLevel','Tech level of an item',1446,1.0,1,'Tech Level',140,1,1,7);
...
INSERT INTO dgmAttributeTypes VALUES(443,'tradePremium',replace(replace('price bonus when selling to npc corps\r\n','\r',char(13)),'\n',char(10)),0,0.0,1,'Trade premium',NULL,1,1,7);
...
INSERT INTO dgmAttributeTypes VALUES(633,'metaLevel','The ranking of the module within its tech level',0,0.0,1,'Meta Level',140,1,1,7);
...
INSERT INTO dgmAttributeTypes VALUES(689,'packageGraphicID','The graphicID used for the structure when it is in package form.',NULL,2390.9999999999999998,0,NULL,NULL,1,1,9);
...
INSERT INTO dgmAttributeTypes VALUES(796,'massAddition','Attribute for adding mass to a ship via an afterburner or MWD.',0,0.0,1,'Mass Addition',2,1,1,7);
...
INSERT INTO dgmAttributeTypes VALUES(798,'entityBracketColour',replace(replace('0: white (default)\r\n1: red (hostile NPC)\r\n2: blue (Neutral NPC)','\r',char(13)),'\n',char(10)),0,0.0,0,NULL,NULL,1,1,31);
...
INSERT INTO dgmAttributeTypes VALUES(927,'miningUpgradeCPUReductionBonus','',0,0.0,0,NULL,NULL,1,1,9);
...
INSERT INTO dgmAttributeTypes VALUES(983,'signatureRadiusAdd','',0,0.0,1,'Signature Radius Modifier',1,1,1,7);
...
INSERT INTO dgmAttributeTypes VALUES(1031,'controlTowerSize',replace(replace('numeric classification for tower size\r\n','\r',char(13)),'\n',char(10)),0,1.0,1,'Control Tower Size',117,1,1,7);
...
INSERT INTO dgmAttributeTypes VALUES(1133,'entityMaxVelocitySignatureRadiusMultiplier','Used to increase signature radius of entity when it activates Max Velocity. Used to fake MWD sig radius increase.',0,6.0,0,NULL,NULL,1,1,9);
...
INSERT INTO dgmAttributeTypes VALUES(1152,'upgradeLoad','How much the upgrades installed on this ship are using of its upgrade capacity.',0,0.0,1,NULL,NULL,1,1,7);
...
INSERT INTO dgmAttributeTypes VALUES(1158,'untargetable','Attribute to disallow targetting.',0,0.0,1,'Untargetable',NULL,1,1,7);
INSERT INTO dgmAttributeTypes VALUES(1159,'armorHPBonusAdd','',0,0.0,1,'Armor Hitpoint Bonus',113,1,1,3);
...
INSERT INTO dgmAttributeTypes VALUES(1162,'explosionDelayWreck','The amount of milliseconds before the wreck dissapears. Note: this only applies to NPC wrecks or empty player wrecks.',0,7199999.9999999999998,0,NULL,NULL,1,1,9);
...
INSERT INTO dgmAttributeTypes VALUES(1332,'falloffBonusBonus','',NULL,1398.9999999999999999,1,'Modification of Falloff Bonus',105,1,1,7);
...
INSERT INTO dgmAttributeTypes VALUES(1456,'npcRemoteArmorRepairThreshold',replace(replace('How damaged does a teammate''s armor need to be before it will be repaired.\r\n0.1 means: Must be below 90% armor to get repairs\r\n0.9 means: Must be below 10% armor to get repairs','\r',char(13)),'\n',char(10)),NULL,0.25,0,NULL,105,1,1,20);
...
INSERT INTO dgmAttributeTypes VALUES(1462,'npcRemoteShieldBoostThreshold',replace(replace('How damaged does a teammates shield need to be before it''ll be repaired.\r\n0.1 means: Must be below 90% shields to get repairs\r\n0.9 means: Must be below 10% shields to get repairs','\r',char(13)),'\n',char(10)),NULL,0.75,0,NULL,109,1,1,20);
...
INSERT INTO dgmAttributeTypes VALUES(1586,'devIndexResearchDevelopment',replace(replace('The required ISK to be present in the research and development\r\ndevelopment index.','\r',char(13)),'\n',char(10)),NULL,0.0,1,'Required Development Index (Research & Development)',NULL,1,1,NULL);
...
INSERT INTO dgmAttributeTypes VALUES(1612,'reinforcementDuration','The number of seconds that the structure will be in reinforcement time',NULL,172799.99999999999999,0,NULL,3,1,1,7);
...
INSERT INTO dgmAttributeTypes VALUES(1648,'AI_ShouldUseTargetSwitching',replace(replace('This controls how L1 AI target switches\r\nWhen disabled AI_ChanceToNotTargetSwitch, AI_ShouldUseEffectMultiplier, and AI_ShouldUseSignatureRadius are disabled also.','\r',char(13)),'\n',char(10)),NULL,0.0,0,NULL,NULL,1,1,12);
...
INSERT INTO dgmAttributeTypes VALUES(1656,'AI_TankingModifierDrone','Tanking modifier applied to drones if their owner is tanking. 1.0 is no modifier',NULL,0.69999999999999995559,0,'Drone Tanking Modifier',NULL,1,1,12);
INSERT INTO dgmAttributeTypes VALUES(1657,'AI_TankingModifier','Tanking modifier applied to ships. 1.0 is no modifier.',NULL,0.69999999999999995559,1,'Tanking Modifier',NULL,1,1,12);
...
INSERT INTO dgmAttributeTypes VALUES(1660,'entityRemoteECMDurationScale','The scaling factor used for the NPC remote ECM',NULL,0.9000000000000000222,1,'NPC Remote ECM Duration Scaling Factor',NULL,1,1,23);
...
INSERT INTO dgmAttributeTypes VALUES(1683,'ecuDecayFactor','',NULL,0.012000000000000000249,1,'decay factor',NULL,1,1,NULL);
INSERT INTO dgmAttributeTypes VALUES(1684,'ecuMaxVolume','',NULL,9.1999999999999992894,1,'Maximum Volume',NULL,1,1,NULL);
...
INSERT INTO dgmAttributeTypes VALUES(1687,'ecuNoiseFactor','',NULL,0.8000000000000000444,0,NULL,NULL,1,1,NULL);
INSERT INTO dgmAttributeTypes VALUES(1688,'shipBonusPirateFaction2','Second Stock Bonus on Pirate Faction Ships.',NULL,0.0,0,NULL,NULL,1,1,9);
INSERT INTO dgmAttributeTypes VALUES(1689,'ecuAreaOfInfluence','',NULL,0.29999999999999998889,0,NULL,NULL,1,1,NULL);
...
INSERT INTO dgmAttributeTypes VALUES(1692,'metaGroupID','meta group of type',NULL,0.0,0,NULL,NULL,1,1,NULL);
...
INSERT INTO dgmAttributeTypes VALUES(1773,'gender',replace(replace('Used to describe what sex a given item is meant for.\r\n\r\n1 = Male,\r\n2 = Unisex,\r\n3 = Female','\r',char(13)),'\n',char(10)),NULL,2.0,1,'Gender',142,1,1,7);
...
INSERT INTO dgmAttributeTypes VALUES(1780,'npcCustomsOfficeTaxRate','',NULL,0.10000000000000000555,0,NULL,NULL,1,1,NULL);
INSERT INTO dgmAttributeTypes VALUES(1781,'defaultCustomsOfficeTaxRate','',NULL,0.10000000000000000555,0,NULL,NULL,1,1,NULL);
...
INSERT INTO dgmAttributeTypes VALUES(1852,'canBeJettisoned',replace(replace('This attribute is not needed by default. You only need to add it if you want to stop something from being jettisoned.\r\n\r\nThe primary case for this was Station Containers.\r\n\r\n0 = Cannot be jettisoned.\r\n1 = Can be jettisoned.','\r',char(13)),'\n',char(10)),NULL,1.0,0,'Can Be Jettisoned',NULL,1,1,NULL);
...
INSERT INTO dgmAttributeTypes VALUES(1919,'tierDifficulty','',NULL,0.0,1,NULL,NULL,1,1,9);
...
INSERT INTO dgmAttributeTypes VALUES(2023,'aoeCloudSizeBonusBonus','',NULL,1398.9999999999999999,1,'Modification of Explosion Radius Bonus',105,1,1,7);
INSERT INTO dgmAttributeTypes VALUES(2024,'aoeVelocityBonusBonus','',NULL,1398.9999999999999999,1,'Modification of Explosion Velocity Bonus',105,1,1,7);
INSERT INTO dgmAttributeTypes VALUES(2025,'missileVelocityBonusBonus','',NULL,1398.9999999999999999,1,'Modification of Missile Velocity Bonus',105,1,1,7);
INSERT INTO dgmAttributeTypes VALUES(2026,'explosionDelayBonusBonus','',NULL,1398.9999999999999999,1,'Modification of Flight Time Bonus',105,1,1,7);
...
INSERT INTO dgmAttributeTypes VALUES(2108,'serviceModuleFuelConsumptionGroup','Fuel consumed by the structure service module',NULL,0.0,0,'Service Module Fuel Need',116,1,1,7);
...
INSERT INTO dgmAttributeTypes VALUES(2150,'fighterSquadronSize',replace(replace('Used by Fighter Logic.\r\nDON''T CHANGE THE DEFAULT VALUE FROM 0','\r',char(13)),'\n',char(10)),0,0.0,0,NULL,NULL,1,1,38);
...
INSERT INTO dgmAttributeTypes VALUES(2189,'fighterAbilityAntiFighterMissileResistance','',NULL,0.2000000000000000111,0,NULL,108,1,0,38);
...
INSERT INTO dgmAttributeTypes VALUES(2219,'fighterHeavySlots','Number of Support Fighters the ship can launch.',2987,0.0,1,'Heavy Fighter Squadrons Limit',NULL,1,1,38);
...
INSERT INTO dgmAttributeTypes VALUES(2244,'fighterAbilityAntiCapitalMissileResistance','',NULL,0.10000000000000000555,0,NULL,108,1,0,38);
...
INSERT INTO dgmAttributeTypes VALUES(2266,'speedFactorFloor','',NULL,-98.999999999999999996,0,NULL,124,1,1,28);
...
INSERT INTO dgmAttributeTypes VALUES(2270,'fighterSquadronRole',replace(replace('0=None\r\n1=Anti-Fighter\r\n2=General\r\n3=Ewar\r\n4=TorpedoBomber\r\n5=AOEBomber','\r',char(13)),'\n',char(10)),NULL,0.0,0,NULL,NULL,1,1,38);
...
INSERT INTO dgmAttributeTypes VALUES(2429,'doomsdayAOEShape',replace(replace('1: Fixed Cylinder (Beam)\r\n2: Cylinder moving in an arc (Slash)\r\n3: Fixed Cone\r\n4: Projected Sphere','\r',char(13)),'\n',char(10)),NULL,0.0,0,'Shape of Superweapon Effect',NULL,1,1,39);
...
INSERT INTO dgmAttributeTypes VALUES(2437,'structureRigPDCapUseBonus','',1400,0.0,1,'Point Defense Battery Capacitor Use Bonus',105,1,1,7);
...
INSERT INTO dgmAttributeTypes VALUES(2515,'npcTrackingDisruptorDuration','',NULL,0.0,0,NULL,101,1,1,26);
INSERT INTO dgmAttributeTypes VALUES(2516,'npcTrackingDisruptorRange','',NULL,0.0,0,NULL,1,1,1,26);
...
INSERT INTO dgmAttributeTypes VALUES(2538,'attributeEquipmentManufactureMaterialMultiplier',replace(replace('Decrease material requirement for manufacturing the following:\r\nShip Modules, Ship Rigs, Personal Deployables, Implants, Cargo Containers','\r',char(13)),'\n',char(10)),NULL,1.0,0,NULL,NULL,1,1,4);
INSERT INTO dgmAttributeTypes VALUES(2539,'attributeEquipmentManufactureTimeMultiplier',replace(replace('Decrease time requirement for manufacturing the following: Ammunition, Charges, Scripts\r\n','\r',char(13)),'\n',char(10)),NULL,1.0,0,NULL,NULL,1,1,4);
INSERT INTO dgmAttributeTypes VALUES(2540,'attributeAmmoManufactureMaterialMultiplier',replace(replace('Decrease material requirement for manufacturing the following:\r\nAmmunition, Charges, Scripts\r\n','\r',char(13)),'\n',char(10)),NULL,1.0,0,NULL,NULL,1,1,4);
INSERT INTO dgmAttributeTypes VALUES(2541,'attributeAmmoManufactureTimeMultiplier',replace(replace('Decrease time requirement for manufacturing the following:\r\nAmmunition, Charges, Scripts','\r',char(13)),'\n',char(10)),NULL,1.0,0,NULL,NULL,1,1,4);
...
INSERT INTO dgmAttributeTypes VALUES(2543,'attributeDroneManufactureTimeMultiplier',replace(replace('Decrease time requirement for manufacturing the following:\r\nDrones, Fighters','\r',char(13)),'\n',char(10)),NULL,1.0,0,NULL,NULL,1,1,4);
INSERT INTO dgmAttributeTypes VALUES(2544,'attributeBasSmallShipManufactureMaterialMultiplier',replace(replace('Decrease material requirement for manufacturing the following:\r\nT1 Frigates, T1 Destroyers, Shuttles','\r',char(13)),'\n',char(10)),NULL,1.0,0,NULL,NULL,1,1,4);
INSERT INTO dgmAttributeTypes VALUES(2545,'attributeBasSmallShipManufactureTimeMultiplier',replace(replace('Decrease time requirement for manufacturing the following:\r\nT1 Frigates, T1 Destroyers, Shuttles','\r',char(13)),'\n',char(10)),NULL,1.0,0,NULL,NULL,1,1,4);
INSERT INTO dgmAttributeTypes VALUES(2546,'attributeBasMediumShipManufactureMaterialMultiplier',replace(replace('Decrease material requirement for manufacturing the following:\r\nT1 Cruisers, T1 Battlecruisers, Industrial Ships,    Mining Barges\r\n\r\n\r\n\r\n','\r',char(13)),'\n',char(10)),NULL,1.0,0,NULL,NULL,1,1,4);
INSERT INTO dgmAttributeTypes VALUES(2547,'attributeBasMediumShipManufactureTimeMultiplier',replace(replace('Decrease time requirement for manufacturing the following:\r\nT1 Cruisers, T1 Battlecruisers, Industrial Ships,    Mining Barges\r\n\r\n\r\n\r\n','\r',char(13)),'\n',char(10)),NULL,1.0,0,NULL,NULL,1,1,4);
INSERT INTO dgmAttributeTypes VALUES(2548,'attributeBasLargeShipManufactureMaterialMultiplier',replace(replace('Decrease material requirement for manufacturing the following:\r\nT1 Battleships, T1 Freighters,                                     Industrial Command Ships\r\n\r\n\r\n\r\n','\r',char(13)),'\n',char(10)),NULL,1.0,0,NULL,NULL,1,1,4);
INSERT INTO dgmAttributeTypes VALUES(2549,'attributeBasLargeShipManufactureTimeMultiplier',replace(replace('Decrease time requirement for manufacturing the following:\r\nT1 Battleships, T1 Freighters,                                     Industrial Command Ships\r\n\r\n\r\n\r\n','\r',char(13)),'\n',char(10)),NULL,1.0,0,NULL,NULL,1,1,4);
INSERT INTO dgmAttributeTypes VALUES(2550,'attributeAdvSmallShipManufactureMaterialMultiplier',replace(replace('Decrease material requirement for manufacturing the following:\r\nT2 Frigates, T2 Destroyers, T3 Destroyers\r\n\r\n\r\n\r\n','\r',char(13)),'\n',char(10)),NULL,1.0,0,NULL,NULL,1,1,4);
INSERT INTO dgmAttributeTypes VALUES(2551,'attributeAdvSmallShipManufactureTimeMultiplier',replace(replace('Decrease time requirement for manufacturing the following:\r\nT2 Frigates, T2 Destroyers, T3 Destroyers\r\n\r\n\r\n\r\n','\r',char(13)),'\n',char(10)),NULL,1.0,0,NULL,NULL,1,1,4);
INSERT INTO dgmAttributeTypes VALUES(2552,'attributeAdvMediumShipManufactureMaterialMultiplier',replace(replace('Decrease material requirement for manufacturing the following:\r\nT2 Cruisers, T2 Battlecruisers, T2 Haulers, Exhumers, T3 Cruisers,T3 Subsystems\r\n\r\n\r\n\r\n','\r',char(13)),'\n',char(10)),NULL,1.0,0,NULL,NULL,1,1,4);
INSERT INTO dgmAttributeTypes VALUES(2553,'attributeAdvMediumShipManufactureTimeMultiplier',replace(replace('Decrease time requirement for manufacturing the following:\r\nT2 Cruisers, T2 Battlecruisers, T2 Haulers, Exhumers, T3 Cruisers,T3 Subsystems\r\n\r\n\r\n\r\n','\r',char(13)),'\n',char(10)),NULL,1.0,0,NULL,NULL,1,1,4);
INSERT INTO dgmAttributeTypes VALUES(2555,'attributeAdvLargeShipManufactureMaterialMultiplier',replace(replace('Decrease material requirement for manufacturing the following:\r\nT2 Battleships, Jump Freighters\r\n\r\n\r\n\r\n','\r',char(13)),'\n',char(10)),NULL,1.0,0,NULL,NULL,1,1,4);
INSERT INTO dgmAttributeTypes VALUES(2556,'attributeAdvLargeShipManufactureTimeMultiplier',replace(replace('Decrease time requirement for manufacturing the following:\r\nT2 Battleships, Jump Freighters\r\n\r\n\r\n\r\n','\r',char(13)),'\n',char(10)),NULL,1.0,0,NULL,NULL,1,1,4);
INSERT INTO dgmAttributeTypes VALUES(2557,'attributeAdvCompManufactureMaterialMultiplier',replace(replace('Decrease material requirement for manufacturing the following:\r\nT2 Components, Tools, Data Interfaces, T3 Components\r\n\r\n\r\n\r\n','\r',char(13)),'\n',char(10)),NULL,1.0,0,NULL,NULL,1,1,4);
INSERT INTO dgmAttributeTypes VALUES(2558,'attributeAdvCompManufactureTimeMultiplier',replace(replace('Decrease time requirement for manufacturing the following:\r\nT2 Components, Tools, Data Interfaces, T3 Components','\r',char(13)),'\n',char(10)),NULL,1.0,0,NULL,NULL,1,1,4);
INSERT INTO dgmAttributeTypes VALUES(2559,'attributeBasCapCompManufactureMaterialMultiplier',replace(replace('Decrease material requirement for manufacturing the following:\r\nCapital Construction Components\r\n\r\n\r\n\r\n','\r',char(13)),'\n',char(10)),NULL,1.0,0,NULL,NULL,1,1,4);
INSERT INTO dgmAttributeTypes VALUES(2560,'attributeBasCapCompManufactureTimeMultiplier',replace(replace('Decrease time requirement for manufacturing the following:\r\nCapital Construction Components\r\n\r\n\r\n\r\n','\r',char(13)),'\n',char(10)),NULL,1.0,0,NULL,NULL,1,1,4);
INSERT INTO dgmAttributeTypes VALUES(2561,'attributeStructureManufactureMaterialMultiplier',replace(replace('Decrease material requirement for manufacturing the following:\r\nStructure Components, Structure Modules,          Upwell Structures, Starbase Structures, Fuel Blocks\r\n\r\n\r\n\r\n','\r',char(13)),'\n',char(10)),NULL,1.0,0,NULL,NULL,1,1,4);
INSERT INTO dgmAttributeTypes VALUES(2562,'attributeStructureManufactureTimeMultiplier',replace(replace('Decrease time requirement for manufacturing the following:\r\nStructure Components, Structure Modules,          Upwell Structures, Starbase Structures, Fuel Blocks\r\n\r\n\r\n\r\n','\r',char(13)),'\n',char(10)),NULL,1.0,0,NULL,NULL,1,1,4);
INSERT INTO dgmAttributeTypes VALUES(2563,'attributeInventionCostMultiplier',replace(replace('Decrease cost requirement for manufacturing the following:\r\nInvention\r\n\r\n\r\n\r\n','\r',char(13)),'\n',char(10)),NULL,1.0,0,NULL,NULL,1,1,4);
INSERT INTO dgmAttributeTypes VALUES(2564,'attributeInventionTimeMultiplier',replace(replace('Decrease time requirement for manufacturing the following:\r\nInvention\r\n\r\n\r\n\r\n','\r',char(13)),'\n',char(10)),NULL,1.0,0,NULL,NULL,1,1,4);
INSERT INTO dgmAttributeTypes VALUES(2565,'attributeMEResearchCostMultiplier',replace(replace('Decrease cost requirement for manufacturing the following:\r\nMaterial Efficiency Blueprint Research\r\n\r\n\r\n\r\n','\r',char(13)),'\n',char(10)),NULL,1.0,0,NULL,NULL,1,1,4);
INSERT INTO dgmAttributeTypes VALUES(2566,'attributeMEResearchTimeMultiplier',replace(replace('Decrease time requirement for manufacturing the following:\r\nMaterial Efficiency Blueprint Research\r\n\r\n\r\n\r\n','\r',char(13)),'\n',char(10)),NULL,1.0,0,NULL,NULL,1,1,4);
INSERT INTO dgmAttributeTypes VALUES(2567,'attributeTEResearchCostMultiplier',replace(replace('Decrease cost requirement for manufacturing the following:\r\nTime Efficiency Blueprint Research\r\n\r\n\r\n\r\n','\r',char(13)),'\n',char(10)),NULL,1.0,0,NULL,NULL,1,1,4);
INSERT INTO dgmAttributeTypes VALUES(2568,'attributeTEResearchTimeMultiplier',replace(replace('Decrease time requirement for manufacturing the following:\r\nTime Efficiency Blueprint Research\r\n\r\n\r\n\r\n','\r',char(13)),'\n',char(10)),NULL,1.0,0,NULL,NULL,1,1,4);
INSERT INTO dgmAttributeTypes VALUES(2569,'attributeBPCopyCostMultiplier',replace(replace('Decrease cost requirement for manufacturing the following:\r\nBlueprint Copying\r\n\r\n\r\n\r\n','\r',char(13)),'\n',char(10)),NULL,1.0,0,NULL,NULL,1,1,4);
INSERT INTO dgmAttributeTypes VALUES(2570,'attributeBPCopyTimeMultiplier',replace(replace('Decrease time requirement for manufacturing the following:\r\nBlueprint Copying\r\n\r\n\r\n\r\n','\r',char(13)),'\n',char(10)),NULL,1.0,0,NULL,NULL,1,1,4);
...
INSERT INTO dgmAttributeTypes VALUES(2575,'attributeCapShipManufactureMaterialMultiplier',replace(replace('Decrease material requirement for manufacturing the following:\r\nCapital Ships','\r',char(13)),'\n',char(10)),NULL,1.0,1,NULL,NULL,1,1,4);
INSERT INTO dgmAttributeTypes VALUES(2576,'attributeCapShipManufactureTimeMultiplier',replace(replace('Decrease time requirement for manufacturing the following:\r\nCapital Ships','\r',char(13)),'\n',char(10)),NULL,1.0,1,NULL,NULL,1,1,4);
...
INSERT INTO dgmAttributeTypes VALUES(2581,'onlineMaxSecurityClass',replace(replace('Determines the maximum security class that a module can be onlined within. Used for structure modules.\r\n\r\n0=Nullsec\r\n1=Lowsec\r\n2=Highsec','\r',char(13)),'\n',char(10)),NULL,2.0,0,NULL,NULL,1,1,7);
...
INSERT INTO dgmAttributeTypes VALUES(2612,'AI_TankingModifierFighter','Tanking modifier applied to fighters if their owner is tanking. 1.0 is no modifier',NULL,1.3000000000000000444,0,NULL,NULL,1,1,12);
...
INSERT INTO dgmAttributeTypes VALUES(2658,'attributeAdvCapCompManufactureMaterialMultiplier',replace(replace('Decrease material requirement for manufacturing the following:\r\nT2 Capital Construction Components','\r',char(13)),'\n',char(10)),NULL,1.0,0,NULL,NULL,1,1,4);
INSERT INTO dgmAttributeTypes VALUES(2659,'attributeAdvCapCompManufactureTimeMultiplier',replace(replace('Decrease time requirement for manufacturing the following:\r\nT2 Capital Construction Components','\r',char(13)),'\n',char(10)),NULL,1.0,0,NULL,NULL,1,1,4);
INSERT INTO dgmAttributeTypes VALUES(2660,'reactionTimeBonus',replace(replace('Skill attribute that reduces time for reactions\r\n jobs','\r',char(13)),'\n',char(10)),1392,0.0,1,'Reaction Time Bonus',105,1,1,7);
...
INSERT INTO dgmAttributeTypes VALUES(2688,'structureHPBonusAdd','',NULL,0.0,1,'Armor Hitpoint Bonus',113,1,1,4);
...
INSERT INTO dgmAttributeTypes VALUES(2699,'asteroidMetaLevel',replace(replace('0: Mission/NPE Ore\r\n1: Standard Ore/Ice\r\n2: +5% Ore\r\n3: +10% Ore\r\n4: High Quality Ice or Extracted Ore\r\n5: Jackpot Moon Ore','\r',char(13)),'\n',char(10)),NULL,0.0,0,NULL,NULL,1,1,7);
...
INSERT INTO dgmAttributeTypes VALUES(2728,'moonAsteroidDecayDisplayValue','This attribute doesn''t directly impact the asteroid decay, but is used to expose the decay time to the show-info window',NULL,48.000000000000000001,1,'Approximate lifetime of spawned asteroids',129,1,1,4);
